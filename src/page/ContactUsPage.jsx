...
const ContactUsPage = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (formValues.email == "" && formValues.note == "") {
    ...
    const handleSubmit = (e) => {
        ...
        const userId = parseInt(userData.user.id);
        data.append("userId", userId);
        data.append("phoneNumber", formValues.phonenumber);
        data.append("feedback", formValues.note);

        axios
            .post(BASE_URL + "sendFeedback.php", data)
            .then((response) => {
                ...
                <div className="w-3/5">
                    <form className="flex flex-col gap-4">
                        ...
                        {isDataLoading ? (
                            ...
                            <Button size="md" disabled={isSubmitDisabled} type="submit" onClick={handleSubmit}>
                                Submit
                            </Button>
                        )}
                    </form>
